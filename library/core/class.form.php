...
class Gdn_Form extends Gdn_Pluggable {
    ...
    public function bodyBox($column = 'Body', $attributes = []) {
        ...
        <div class="richEditor" aria-label="<?php echo t('Type your message');?>" aria-describedby="richEditor-description" role="textbox" aria-multiline="true">
            ...
            <div class="richEditorParagraphMenu">
            ...
            <div class="richEditor-frame">
                ...
                <div class="richEditor-insertMenu">
                    <ul class="richEditor-embedMenu" role="menubar" aria-label="<?php echo t('Embed Menu'); ?>">
                        <li class="richEditor-menuItem" role="menuitem">
                            <button class="richEditor-button richEditor-embedButton">
                                <svg class="richEditorInline-icon" viewBox="0 0 24 24">
                                    <title><?php echo t('Bold'); ?></title>
                                    <path fill="#555A62" d="M6.5115,18 L6.5115,17.38 C6.86283509,17.3696666 7.14441561,17.3386669 7.35625,17.287 C7.56808439,17.2353331 7.73341607,17.1475006 7.85225,17.0235 C7.97108393,16.8994994 8.05116646,16.7238345 8.0925,16.4965 C8.13383354,16.2691655 8.1545,15.9746685 8.1545,15.613 L8.1545,8.452 C8.1545,8.09033152 8.13900015,7.79841778 8.108,7.57625 C8.07699984,7.35408222 8.01241716,7.17841731 7.91425,7.04925 C7.81608284,6.92008269 7.68175085,6.83225023 7.51125,6.78575 C7.34074915,6.73924977 7.11600139,6.70566677 6.837,6.685 L6.837,6.065 L11.8125,6.065 C13.3728411,6.065 14.5740791,6.31558083 15.41625,6.81675 C16.2584209,7.31791917 16.6795,8.03349535 16.6795,8.9635 C16.6795,10.1931728 15.7960088,11.0611641 14.029,11.5675 L14.029,11.6295 C14.5973362,11.6295 15.1114144,11.7095825 15.57125,11.86975 C16.0310856,12.0299175 16.4211651,12.2546652 16.7415,12.544 C17.0618349,12.8333348 17.3098325,13.1743314 17.4855,13.567 C17.6611675,13.9596686 17.749,14.3884977 17.749,14.8535 C17.749,15.3805026 17.6224179,15.8403314 17.36925,16.233 C17.1160821,16.6256686 16.7518357,16.956332 16.2765,17.225 C15.3568287,17.7416693 14.0910081,18 12.479,18 L6.5115,18 Z M12.5875,17.0545 C14.251175,17.0545 15.083,16.3053408 15.083,14.807 C15.083,13.8873287 14.7833363,13.2156688 14.184,12.792 C13.8739984,12.5749989 13.4735858,12.4200005 12.98275,12.327 C12.4919142,12.2339995 11.8900036,12.1875 11.177,12.1875 L10.433,12.1875 L10.433,15.2875 C10.433,15.9281699 10.5983317,16.382832 10.929,16.6515 C11.2596683,16.920168 11.8124961,17.0545 12.5875,17.0545 Z M11.3475,11.2575 C11.8125023,11.2575 12.2154983,11.2135838 12.5565,11.12575 C12.8975017,11.0379162 13.1868321,10.9113342 13.4245,10.746 C13.9205025,10.4049983 14.1685,9.87283695 14.1685,9.1495 C14.1685,8.39516289 13.9825019,7.85008501 13.6105,7.51425 C13.2384981,7.17841499 12.6391708,7.0105 11.8125,7.0105 L10.712,7.0105 C10.5259991,7.0105 10.433,7.09833246 10.433,7.274 L10.433,11.2575 L11.3475,11.2575 Z"/>
                                </svg>
                            </button>
                        </li>
                    </ul>
            ...
            <div class="richEditorParagraphMenu-popover">
                <ul class="richEditor-menuItems" role="menubar" aria-label="<?php echo t('Paragraph Level Formatting Menu'); ?>">
                    <li class="richEditor-menuItem" role="menuitem">
                        <button class="richEditor-button">
                            <svg class="richEditorInline-icon" viewBox="0 0 24 24">
                                <title>¶</title>
                                <path fill="currentColor" fill-rule="evenodd" d="M15,6 L17,6 L17,18 L15,18 L15,6 Z M11,6 L13.0338983,6 L13.0338983,18 L11,18 L11,6 Z M11,13.8666667 C8.790861,13.8666667 7,12.1056533 7,9.93333333 C7,7.76101332 8.790861,6 11,6 C11,7.68571429 11,11.6190476 11,13.8666667 Z"/>
                            </svg>
